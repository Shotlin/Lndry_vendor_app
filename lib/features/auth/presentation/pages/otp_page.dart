              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      phoneNum.isNotEmpty
                          ? l10n.authOtpSubtitleWithPhone(phoneNum)
                          : l10n.authOtpSubtitleGeneric,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: authState is AuthLoading
                            ...
                            : Text(l10n.authVerifyCodeButton),
                      ),
                    ),
                    SizedBox(height: 24.h),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          _canResend ? l10n.authResendPrompt : l10n.authResendCountdownPrefix,
                          style: AppTypography.bodyMedium.copyWith(
                            color: AppColors.textSecondary,
                          ),
                        ),
                        _canResend
                            ...
                            : Text(
                                l10n.authResendCountdownSeconds(_secondsRemaining),
                                style: AppTypography.bodyMedium.copyWith(
                                  color: AppColors.primary,
                                  fontWeight: FontWeight.bold,
                                ),
