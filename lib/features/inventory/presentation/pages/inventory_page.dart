...
class _InventoryPageState extends State<InventoryPage> {
              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(labelText: l10n.inventoryItemNameLabel, hintText: l10n.inventoryItemNameHint),
                    validator: (value) => value == null || value.isEmpty ? l10n.inventoryRequiredField : null,
                  ),
                  SizedBox(height: 8.h),
                  Row(
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(labelText: l10n.inventoryInitialQtyLabel),
                          validator: (value) => value == null || value.isEmpty ? l10n.inventoryRequiredField : null,
                        ),
                      ),
                      SizedBox(width: 8.w),
                      Expanded(
                        child: TextFormField(
                          ...
                          keyboardType: TextInputType.number,
                          decoration: InputDecoration(labelText: l10n.inventoryMinLimitLabel),
                          validator: (value) => value == null || value.isEmpty ? l10n.inventoryRequiredField : null,
                        ),
                      ),
                    ],
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(labelText: l10n.inventoryUnitLabel, hintText: l10n.inventoryUnitHint),
                    validator: (value) => value == null || value.isEmpty ? l10n.inventoryRequiredField : null,
                  ),
                ],
              ),
  ...
  void _saveItem() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(AppLocalizations.of(context).inventoryItemAddedSnack)));
    }
  }
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          l10n.inventoryLowStockWarningBody(lowStockItems.length),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  if (isLowStock) ...[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        item.quantity == 0 ? l10n.inventoryOutBadge : l10n.inventoryLowBadge,
                                        style: TextStyle(
                                          fontSize: 9.sp,
                                          fontWeight: FontWeight.bold,
                                          color: statusColor,
                              ...
                              SizedBox(height: 4.h),
                              Text(
                                l10n.inventoryQuantityOfThreshold('${item.quantity}', '${item.minThreshold}', item.unit),
